...
class __TwigTemplate_82e52f9e4ce3597f6e6bd5d7b028c0175d45c3cc157e3aa841fba077fa4a4c62 extends \Twig\Template
{
...
($context["item"] ?? null), "url", []), "getOption", [0 => "attributes"], "method"), "class", [])) ? (twig_join_filter($this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute($this->getAttribute(($context["item"] ?? null), "url", []), "getOption", [0 => "attributes"], "method"), "class", [])), " ")) : (""))];
        // line 26
        echo "<li";
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["attributes"] ?? null), "addClass", [0 => ((($context["is_active"] ?? null)) ? ("active") : ("")), 1 => "nav-item"], "method")), "html", null, true));
        echo ">";
...
", "themes/contrib/bootstrap_barrio/templates/navigation/menu-local-task.html.twig", "/app/drupal-8.8.2/themes/contrib/bootstrap_barrio/templates/navigation/menu-local-task.html.twig");
    }
}
