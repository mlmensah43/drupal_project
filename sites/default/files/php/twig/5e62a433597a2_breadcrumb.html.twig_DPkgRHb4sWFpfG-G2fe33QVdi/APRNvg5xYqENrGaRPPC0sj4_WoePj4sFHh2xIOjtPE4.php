...
class __TwigTemplate_cfd6fc7a788a9e932b7368971bc5fdd5a6647d1c461715d519b876fff1881ffc extends \Twig\Template
{
    ...
    {
        // line 10
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->env->getExtension('Drupal\Core\Template\TwigExtension')->attachLibrary("bootstrap_barrio/breadcrumb"), "html", null, true));
        echo "
...
{% endif %}
", "themes/contrib/bootstrap_barrio/templates/navigation/breadcrumb.html.twig", "/app/drupal-8.8.2/themes/contrib/bootstrap_barrio/templates/navigation/breadcrumb.html.twig");
    }
}
