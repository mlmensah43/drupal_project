...
class __TwigTemplate_bf6a583eb599a7d0b90f1c49084b9931221bb10ad303d1677ce08aea74306bd4 extends \Twig\Template
{
    ...
    {
        // line 16
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->env->getExtension('Drupal\Core\Template\TwigExtension')->attachLibrary("bootstrap_barrio/tabs"), "html", null, true));
        echo "
";
        // line 17
...
{% endif %}
", "themes/contrib/bootstrap_barrio/templates/navigation/menu-local-tasks.html.twig", "/app/drupal-8.8.2/themes/contrib/bootstrap_barrio/templates/navigation/menu-local-tasks.html.twig");
    }
}
